...
//    434076250,        // RFFrequency   7,9호기
    ...
    7,                // SpreadingFactor [6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]  //9
    2,                // ErrorCoding [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
    true,             // CrcOn [0: OFF, 1: ON]
    false,            // ImplicitHeaderOn [0: OFF, 1: ON]
    0,                // RxSingleOn [0: Continuous, 1 Single]  // master =1  slave=0;
    0,                // FreqHopOn [0: OFF, 1: ON]
    4,                // HopPeriod Hops every frequency hopping period symbols
	1000, //2000, //    500,              // TxPacketTimeout
	1000, //2000, //    500,              // RxPacketTimeout
...
////////////////////////////////////
//SX1276ReadBuffer( REG_LR_DIOMAPPING1, youbuffer+1,10);
//SX1276ReadBuffer( REG_LR_OPMODE, youbuffer+1,0x70);
//SX1276LoRaSetOpMode( RFLR_OPMODE_TRANSMITTER );

/*
        SX1276ReadBuffer( REG_LR_OPMODE ,youbuffer, 1 );

//        SX1276Write( 0x1d, 0x00 );
        SX1276ReadBuffer( 0x1d ,&youbuffer[1], 1 );

        SX1276ReadBuffer( REG_LR_FIFOTXBASEADDR ,&youbuffer[7], 1 );
		youbuffer[8]=SX1276LR->RegFifoTxBaseAddr;
////////////////////////////////////
*/
