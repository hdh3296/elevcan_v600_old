...
extern	void WriteSPI_ADDR_n( unsigned char addr,unsigned char *buffer, unsigned char size );
extern	void ReadSPI_ADDR_n( unsigned char addr,unsigned char *buffer, unsigned char size );
