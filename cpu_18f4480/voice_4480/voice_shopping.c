...
#define         POSITION              0
#define         UP_VOICE              1
#define         OVERLOAD_VOICE        2
#define         POWER_DOWN_VOICE      3
#define         HWAJAE_VOICE          4
#define         EMERGENCY_VOICE       5
#define         OPEN_VOICE      	  6
#define         DOWN_VOICE            7
#define         DINGDONG              8
#define         CLOSE_VOICE           9
#define         START_VOICE           10
#define         FLOOR_U8              12  
#define         FLOOR_U7              FLOOR_U8+1  
#define         FLOOR_U6              FLOOR_U8+2  
#define         FLOOR_U5              FLOOR_U8+3  
#define         FLOOR_U4              FLOOR_U8+4  
#define         FLOOR_U3              FLOOR_U8+5  
#define         FLOOR_U2              FLOOR_U8+6  
#define         FLOOR_U1              FLOOR_U8+7  
#define         FLOOR_1               FLOOR_U8+8
#define         FLOOR_P               25 //26
#define         TURN_OFF_1            28 //29
#define         TURN_OFF_P            29 //30
...
#define         FLOOR_G                 FLOOR_U7+34
#define         FLOOR_M                 FLOOR_U7+35
#define         FLOOR_L                 FLOOR_U7+36
#define         FLOOR_PH                FLOOR_U7+37
#define         FLOOR_NO                FLOOR_U7+38
#define         FLOOR_B5          		FLOOR_U7+39
#define         FLOOR_B4          		FLOOR_U7+40
#define         FLOOR_B3          		FLOOR_U7+41
#define         FLOOR_B2          		FLOOR_U7+42
#define         FLOOR_B1          		FLOOR_U7+43
#define         FLOOR_F1          		FLOOR_U7+44
#define         FLOOR_F2          		FLOOR_U7+45
#define         FLOOR_F3          		FLOOR_U7+46
#define         FLOOR_F4          		FLOOR_U7+47
#define         FLOOR_F5          		FLOOR_U7+48
#define         FLOOR_F6          		FLOOR_U7+49
#define         FLOOR_F7          		FLOOR_U7+50
#define         FLOOR_F8          		FLOOR_U7+51
#define         FLOOR_F9          		FLOOR_U7+52
#define         FLOOR_F10         		FLOOR_U7+53
#define         FLOOR_F11          		FLOOR_U7+54
#define         FLOOR_F12          		FLOOR_U7+55
#define         FLOOR_F13          		FLOOR_U7+56
#define         FLOOR_F14          		FLOOR_U7+57
#define         FLOOR_F15          		FLOOR_U7+58
#define         FLOOR_F16          		FLOOR_U7+59
#define         FLOOR_F17          		FLOOR_U7+60
#define         FLOOR_F18          		FLOOR_U7+61
#define         FLOOR_F19          		FLOOR_U7+62
#define         FLOOR_F20         		FLOOR_U7+63
#define         FLOOR_F21          		FLOOR_U7+64
#define         FLOOR_F22          		FLOOR_U7+65
#define         FLOOR_F23          		FLOOR_U7+66
#define         FLOOR_F24          		FLOOR_U7+67
#define         FLOOR_F25          		FLOOR_U7+68
#define         FLOOR_F26          		FLOOR_U7+69
#define         FLOOR_F27          		FLOOR_U7+70
#define         FLOOR_PARKING      		FLOOR_U7+71
#define         OPEN_VOICE      		FLOOR_U7+72
#define         CANCLE_VOICE      		FLOOR_U7+73
#define         PUSH_VOICE      		FLOOR_U7+74
#define         FLOOR_S            		FLOOR_U7+75
*/
...
/*
		if( (UpDnVoiceTime > 50) && (RcvBuf[IdPt+1] & 0x01) && !updown_valid && (byou==0) && !VoiceRun){  		
...
*/
		...
		if( !(RcvBuf[IdPt+2] & S2_CAR_MOVE)){
			if((RcvBuf[IdPt + 21 ] == 57) && (SelVoice != OPEN_VOICE) && !byou && !VoiceRun){  //open
		        CurVoice=OPEN_VOICE;	
				byou=1;
			}
			
			else if((CarCheckTime>30) && !bTurnOffVoice  && !VoiceRun){  //open
				if(RcvBuf[IdPt+0]==1){
					CurVoice=TURN_OFF_P;
					bTurnOffVoice=1;
				}
			...
			else if((RcvBuf[IdPt + 21 ] == 58) && !bCloseVoice && !VoiceRun){
	...
	if((RcvBuf[IdPt+2] & S2_CAR_MOVE) || (SelVoice == OPEN_VOICE) || (RcvBuf[IdPt + 28] & 0x40)){
		CarCheckTime=0;      
		bTurnOffVoice=0;
	}
...
//    unsigned char i;
    ...
    if( TMR0IF )
    {
		...
		if(abctimer>100){
			...
			if(FloorXCnt<200)		FloorXCnt++;
			if(CarCheckTime<200)	CarCheckTime++;
		}
