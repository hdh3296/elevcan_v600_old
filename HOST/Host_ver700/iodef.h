...
//#define     RUSSIA_HALL_DOOR_STOP		1      




#define		AUTO_LANDING_485				1
//#define		AUTO_LANDING_CAN			1
...
#define		EDS_AUTOLANDING_CAN				1
#define		DELTA_INVERTER_AUTOLANDING_CAN	2
#define		AUTO_LANDING_COMM				1
#endif
...
#define  OFFSET_LIMIT_SUSD    100 // 100mm
...
extern	unsigned long 	MmBuf,PulseBuf;
...
////decrease start time and real decrease set check 
extern	unsigned 	int 	DecStartTime;
extern	unsigned 	long 	DecStartTimeMpm;

extern	unsigned 	long 	NewMpm;
...
extern	unsigned long   CurMpm_100;  // 000.000
...
extern	UserDataType 	xTunningSeq,BefxTunningSeq;
...
extern	UserDataType    ParRdWrReadyTimer;
extern	UserDataType    ParRdWrTime;
extern	UserDataType	ParRdWrNm,BefParRdWrNm;
...
#define  bFindSD         		GET_BITFIELD(&StateBit5).bit4 
...
#define  bInvMdfy      			GET_BITFIELD(&StateBit11).bit3 
#define  bWarning				GET_BITFIELD(&StateBit11).bit4 
...
extern	UserDataType	Com1Crc;	


extern	unsigned int 	HallDoorOpenTime;

extern	unsigned int 	CurAmp;

extern	unsigned char ThisRdWrAddrH,ThisRdWrAddrL,ThisRdWrWNm,ThisRdWrValueH,ThisRdWrValueL,ThisRdWrMode;		



extern	unsigned int InverterAddress;
extern	unsigned int IM_Motor_ID;
extern	unsigned int PM_Motor_ID;

extern	unsigned int TunningValue1;
extern	unsigned int TunningValue2;
extern	unsigned int TunningValue3;

extern	unsigned int Addr_MotorType;
extern	unsigned int Addr_MaxHz;
extern	unsigned int Addr_MaxEvSpd;
extern	unsigned int Addr_IM_MotorHz;
extern	unsigned int Addr_PM_MotorHz;
extern	unsigned int Addr_IM_MotorVlot;
extern	unsigned int Addr_PM_MotorVlot;
extern	unsigned int Addr_IM_MotorAmp;
extern	unsigned int Addr_PM_MotorAmp;
extern	unsigned int Addr_IM_MotorKw;
extern	unsigned int Addr_PM_MotorKw;
extern	unsigned int Addr_IM_MotorRpm;
extern	unsigned int Addr_PM_MotorRpm;
extern	unsigned int Addr_IM_MotorPole;
extern	unsigned int Addr_PM_MotorPole;
extern	unsigned int Addr_IM_NoLdAmp;
extern	unsigned int Addr_PM_MotorDeg;
extern	unsigned int Addr_IM_EncoderPulse;
extern	unsigned int Addr_PM_EncoderPulse;
extern	unsigned int Addr_EncoderAB;
extern	unsigned int Addr_Run_Zero;
extern	unsigned int Addr_Stop_Zero;
extern	unsigned int Addr_Gain1;
extern	unsigned int Addr_Gain2;
extern	unsigned int Addr_IM_Tunning;
extern	unsigned int Addr_PM_Tunning;


extern	unsigned int Addr_Dec_Time;
extern	unsigned int Addr_SCurve_Time;
extern	unsigned int Addr_DecSpdPort;
extern	unsigned int Addr_ManualSpdPort;
extern	unsigned int Addr_LowSpdPort;
extern	unsigned int Addr_MidSpdPort;
extern	unsigned int Addr_HighSpdPort;

extern	unsigned int Addr_CurError;
extern	unsigned int Addr_CurAmp;
