...
///////////////////////////////////////////////////
//ver 6.14--> 6.16 modify(2016-10-07)
///////////////////////////////////////////////////
//1.error 시 door open
//2.default setup 수정
//3.kidscall 수정 3-1
...
//unsigned	int			CarErrorOnTime=0;	//161005
...
/*
			if(bCarErrOn){
				if(CarErrorOnTime < 200)	CarErrorOnTime++;
			}
			else					CarErrorOnTime=0;		
*/
